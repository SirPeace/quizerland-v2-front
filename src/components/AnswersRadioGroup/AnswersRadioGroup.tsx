...
const defaultAnswerStyles: IFormControlStyles = {
	icon: <Radio className="text-blue-500" />,
	text: 'text-blue-400',
}
const correctAnswerStyles: IFormControlStyles = {
	icon: (
		<VerifiedOutlinedIcon className="text-green-600" sx={{ margin: '9px' }} />
	),
	text: 'text-green-600',
}
const wrongAnswerStyles: IFormControlStyles = {
	icon: (
